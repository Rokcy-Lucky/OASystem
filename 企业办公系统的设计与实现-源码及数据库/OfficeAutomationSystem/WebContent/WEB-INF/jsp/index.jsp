				...
				<dd>
					...
					<ul>
						<c:forEach items="${map.value}" var="list">
							<li><a data-href="${list.t_power_uri}"
								data-title="${list.t_power_name}" href="javascript:void(0)">${list.t_power_name}</a></li>
						</c:forEach>
					</ul>
