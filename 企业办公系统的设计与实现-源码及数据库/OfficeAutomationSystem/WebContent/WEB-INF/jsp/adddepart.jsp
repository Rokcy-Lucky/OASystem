...
<body>
	...
	<form action="add.do" method="post" class="form form-horizontal" id="">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
				class="c-red">*</span>部门编号：</label>
	...
	<!-- <form action="add.do" method="post" class="form form-horizontal" id=""> -->
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" readonly="true" class="input-text" value=""
					placeholder="" id="" name="branchname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span
				...
				<c:forEach items="${branchBean}" var="list">
					<div class="radio-box">
						<input type="radio" value="${list.t_branchinfo_id}"
							name="branchId"> <label for="sex">${list.t_branchinfo_name}</label>
					</div>
				</c:forEach>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9 skin-minimal">
					<c:forEach items="${userBean}" var="list">
						<div class="radio-box">
							...
							<label for="sex">${list.t_userinfo_name}</label>
						</div>
					</c:forEach>
				</div>
			</div>
