...
<body>
	...
	<form action="updatedepart.do" method="post" class="form form-horizontal"
		id="lcform">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">机构编号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" readonly="true" class="input-text"
					value="${list2.t_branchinfo_id}" placeholder="" id=""
					name="branchid">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" readonly="true" class="input-text"
					value="${list.t_userinfo_id}" placeholder="" id=""
					name="userid">
			</div>
		</div>
