	...
	<form class="form form-horizontal" id="form-admin-add"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="depart" type="radio" id="depart-1" value="1" checked>
					<label for="sex-1">研发部</label>
				</div>
				<div class="radio-box">
					<input name="depart" type="radio" id="depart-2" value="2">
					<label for="sex-2">销售部</label>
				</div>
				<div class="radio-box">
					<input name="depart" type="radio" id="depart-3" value="3">
					<label for="sex-2">财务部</label>
				</div>
				<div class="radio-box">
					<input name="depart" type="radio" id="depart-4" value="4">
					<label for="sex-2">技术部</label>
				</div>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				...
				<div class="radio-box">
					<input name="sex" type="radio" id="sex-2" value="女"> <label
						for="sex-2">女</label>
				</div>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				...
				<div class="radio-box">
					<input name="role" type="radio" id="role-2" value="2"> <label
						for="sex-2">部门经理</label>
				</div>
				
				<div class="radio-box">
					<input name="role" type="radio" id="role-3" value="3"> <label
						for="sex-2">普通员工</label>
				</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="state" type="radio" id="state-1" value="1" checked>
