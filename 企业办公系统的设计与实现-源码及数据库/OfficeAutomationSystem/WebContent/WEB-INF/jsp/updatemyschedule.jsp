	...
	<form class="form form-horizontal" id="form-article-add"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" readonly="readonly" class="input-text" value="${myschedule.t_schedule_id }" id="scheduleid"
					name="scheduleid"> 
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${myschedule.t_schedule_title }"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${myschedule.t_schedule_address }"
			...
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box"> <select id="meetingifo"
					...
					style="appearance: none; -moz-appearance: none; -webkit-appearance: none; -ms-appearance: none;">
						<option>${myschedule.t_meetinginfo_id }</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" value="${myschedule.t_schedule_begintime }"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" value="${myschedule.t_schedule_endtime }"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${myschedule.t_schedule_content }"
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${myschedule.t_schedule_createuser }"
					readonly="readonly" id="createuser" name="createuser">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span
