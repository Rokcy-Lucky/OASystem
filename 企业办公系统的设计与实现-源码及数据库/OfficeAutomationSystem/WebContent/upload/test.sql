...
CREATE TABLE `t_manage_power` (
  ...
  CONSTRAINT `t_manage_power_ibfk_2` FOREIGN KEY (`t_power_id`) REFERENCES `t_power` (`t_power_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `t_manage_power_ibfk_1` FOREIGN KEY (`t_manage_id`) REFERENCES `t_manage` (`t_manage_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `t_manage_power` VALUES ('8', '3', '7');
INSERT INTO `t_manage_power` VALUES ('9', '3', '7');
INSERT INTO `t_manage_power` VALUES ('10', '4', '10');
INSERT INTO `t_manage_power` VALUES ('11', '4', '11');
INSERT INTO `t_manage_power` VALUES ('12', '5', '12');
INSERT INTO `t_manage_power` VALUES ('13', '5', '13');
INSERT INTO `t_manage_power` VALUES ('14', '5', '14');
...
-- Records of t_power
-- ----------------------------
INSERT INTO `t_power` VALUES ('1', '机构管理', '');
INSERT INTO `t_power` VALUES ('2', '部门管理', '');
INSERT INTO `t_power` VALUES ('3', '员工管理', '');
INSERT INTO `t_power` VALUES ('4', '我的日程', '');
INSERT INTO `t_power` VALUES ('5', '部门日程', '');
INSERT INTO `t_power` VALUES ('6', '我的便签', '');
INSERT INTO `t_power` VALUES ('7', '文档管理', '');
INSERT INTO `t_power` VALUES ('9', '回收站', '');
INSERT INTO `t_power` VALUES ('10', '文件搜索', '');
INSERT INTO `t_power` VALUES ('11', '消息管理', '');
INSERT INTO `t_power` VALUES ('12', '信箱', '');
INSERT INTO `t_power` VALUES ('13', '角色管理', '');
INSERT INTO `t_power` VALUES ('14', '登录日志', '');
INSERT INTO `t_power` VALUES ('15', '操作日志', '');
INSERT INTO `t_power` VALUES ('16', '考勤统计', '');
INSERT INTO `t_power` VALUES ('17', '考勤历史记录查询', '');
...
CREATE TABLE `t_roleinfo_manage` (
  ...
  KEY `t_manage_id` (`t_manage_id`),
  CONSTRAINT `t_roleinfo_manage_ibfk_2` FOREIGN KEY (`t_manage_id`) REFERENCES `t_manage` (`t_manage_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `t_roleinfo_manage_ibfk_1` FOREIGN KEY (`t_roleinfo_id`) REFERENCES `t_roleinfo` (`t_roleinfo_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
