...
public class DepartPojo implements Serializable {
	...
	public DepartPojo(String t_departinfo_id, String t_departinfo_name, String t_branchinfo_name,
			String t_userinfo_name, String t_departinfo_tel, String t_departinfo_mobiletel, String t_departinfo_faxes) {
		super();
	...
	public String toString() {
		return "DepartPojo [t_departinfo_id=" + t_departinfo_id + ", t_departinfo_name=" + t_departinfo_name
				+ ", t_branchinfo_name=" + t_branchinfo_name + ", t_userinfo_name=" + t_userinfo_name
				+ ", t_departinfo_tel=" + t_departinfo_tel + ", t_departinfo_mobiletel=" + t_departinfo_mobiletel
				+ ", t_departinfo_faxes=" + t_departinfo_faxes + "]";
	}
