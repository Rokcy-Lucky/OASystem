...
public class DepartBean {
	...
	public DepartBean(int t_departinfo_id, String t_departinfo_name, String t_userinfo_id, String t_userinfo_name,
			String t_branchinfo_id, String t_departinfo_tel, String t_departinfo_mobiletel, String t_departinfo_faxes) {
		super();
