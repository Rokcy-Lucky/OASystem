...
public class UserBean implements Serializable {
	...
	public String toString() {
		return "UserBean [t_userinfo_id=" + t_userinfo_id + ", t_userinfo_name=" + t_userinfo_name
				+ ", t_userinfo_password=" + t_userinfo_password + ", t_userstate_id=" + t_userstate_id
				+ ", t_roleinfo_id=" + t_roleinfo_id + ", t_userinfo_gender=" + t_userinfo_gender + ", t_departinfo_id="
				+ t_departinfo_id + "]";
	}
